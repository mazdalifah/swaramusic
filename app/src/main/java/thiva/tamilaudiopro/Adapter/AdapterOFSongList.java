...
public class AdapterOFSongList extends RecyclerView.Adapter<AdapterOFSongList.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, int position) {
        ...
        Picasso.get()
                .load(uri)
                .placeholder(R.drawable.ic_audio_tag)
        ...
        if (PlayerService.getIsPlayling() && Setting.arrayList_play.get(Setting.playPos).getId().equals(arrayList.get(position).getId())) {
            ...
            if (Setting.Dark_Mode) {
                holder.rl.setBackgroundColor(ContextCompat.getColor(context, R.color.tt_dr));
                holder.textView_song.setTextColor(ContextCompat.getColor(context, R.color.tt_title_dr));
            } else {
                holder.rl.setBackgroundColor(ContextCompat.getColor(context, R.color.tt));
                holder.textView_song.setTextColor(ContextCompat.getColor(context, R.color.tt_title));
            }
        } else {
            ...
            if (Setting.Dark_Mode) {
                holder.rl.setBackgroundColor(ContextCompat.getColor(context, android.R.color.transparent));
                holder.textView_song.setTextColor(ContextCompat.getColor(context, R.color.tt_title_normal_dr));
            } else {
                holder.rl.setBackgroundColor(ContextCompat.getColor(context, android.R.color.transparent));
                holder.textView_song.setTextColor(ContextCompat.getColor(context, R.color.tt_title_normal));
            }
        ...
        holder.rl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Setting.isDownloaded = type.equals("downloads");
