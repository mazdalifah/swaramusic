...
import static thiva.tamilaudiopro.Color_Pik.ColorUtils.dip2px;
import static thiva.tamilaudiopro.Color_Pik.ColorUtils.getDimensionDp;
...
public class ColorPicker {
    ...
    public ColorPicker(Activity context) {
        ...
        this.dismiss = true;
        this.marginColorButtonLeft = this.marginColorButtonTop = this.marginColorButtonRight = this.marginColorButtonBottom = 4;
    ...
    public ColorPicker addListenerButton(String text, final OnButtonListener listener) {
        ...
        button.setPadding(
                getDimensionDp(R.dimen.action_button_padding_horizontal, context) + dip2px(4, context), 0,
                getDimensionDp(R.dimen.action_button_padding_horizontal, context) + dip2px(4, context), 0);
