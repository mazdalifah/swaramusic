package thiva.tamilaudiopro.views.Equalizer;
...
public class EqualizerFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        equalizerSwitch.setOnCheckedChangeListener(new SwitchButton.OnCheckedChangeListener() {
            @Override
...
//            seekBar.setLayoutParams(layoutParams);
    ...
    public void equalizeSound() {
        ...
        ArrayAdapter<String> equalizerPresetSpinnerAdapter = new ArrayAdapter<>(ctx,
               R.layout.spinner_item_equalizer,
