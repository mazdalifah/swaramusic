...
import thiva.tamilaudiopro.Adapter.AdapterServerPlaylist;
import thiva.tamilaudiopro.SharedPre.Setting;
import thiva.tamilaudiopro.Utils.NavigationUtil;
import thiva.tamilaudiopro.asyncTask.LoadServerPlaylist;
...
public class FragmentServerPlaylist extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        methods = new Methods(getActivity(), new InterAdListener() {
            ...
            public void onClick(int position, String type) {
                NavigationUtil.SongByServerPlaylistActivity(getActivity(),getString(R.string.playlist), adapter.getItem(position));
            }
        });
    ...
    private void loadPlaylist() {
        if (methods.isNetworkAvailable()) {
            ...
            }, methods.getAPIRequest(ItemName.METHOD_SERVER_PLAYLIST, page, "", "", "", "", "", "", "", "", "","","","","","","", null));
