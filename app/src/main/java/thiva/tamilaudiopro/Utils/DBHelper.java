...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String TAG_ABOUT_NEMOSOFT_KEY = "my_key";
    private static final String TAG_ABOUT_PURCHASE_CODE = "my_code";
    ...
    private String[] columns_about = new String[]{TAG_ABOUT_NAME, TAG_ABOUT_LOGO, TAG_ABOUT_VERSION, TAG_ABOUT_AUTHOR, TAG_ABOUT_CONTACT,
            TAG_ABOUT_EMAIL, TAG_ABOUT_WEBSITE, TAG_ABOUT_DESC, TAG_ABOUT_DEVELOPED, TAG_ABOUT_PRIVACY, TAG_ABOUT_NEMOSOFT_KEY,
            TAG_ABOUT_PURCHASE_CODE};
    ...
    private static final String CREATE_TABLE_ABOUT = "create table " + TABLE_ABOUT + "(" +
            ...
            TAG_ABOUT_NEMOSOFT_KEY + " TEXT, " +
            TAG_ABOUT_PURCHASE_CODE + " TEXT);";
    ...
    public void addtoAbout() {
        try {
            ...
            ContentValues contentValues = new ContentValues();
            contentValues.put(TAG_ABOUT_NAME, Setting.itemAbout.getAppName());
            contentValues.put(TAG_ABOUT_LOGO, Setting.itemAbout.getAppLogo());
            contentValues.put(TAG_ABOUT_VERSION, Setting.itemAbout.getAppVersion());
            contentValues.put(TAG_ABOUT_AUTHOR, Setting.itemAbout.getAuthor());
            contentValues.put(TAG_ABOUT_CONTACT, Setting.itemAbout.getContact());
            contentValues.put(TAG_ABOUT_EMAIL, Setting.itemAbout.getEmail());
            contentValues.put(TAG_ABOUT_WEBSITE, Setting.itemAbout.getWebsite());
            contentValues.put(TAG_ABOUT_DESC, Setting.itemAbout.getAppDesc());
            contentValues.put(TAG_ABOUT_DEVELOPED, Setting.itemAbout.getDevelopedby());
            contentValues.put(TAG_ABOUT_PRIVACY, Setting.itemAbout.getPrivacy());
            contentValues.put(TAG_ABOUT_NEMOSOFT_KEY, Setting.nemosofts_key);
            contentValues.put(TAG_ABOUT_PURCHASE_CODE, Setting.purchase_code);
    ...
    public Boolean getAbout() {
        ...
        if (c != null && c.getCount() > 0) {
            ...
            for (int i = 0; i < c.getCount(); i++) {
                ...
                Setting.nemosofts_key = c.getString(c.getColumnIndex(TAG_ABOUT_NEMOSOFT_KEY));
                Setting.purchase_code = c.getString(c.getColumnIndex(TAG_ABOUT_PURCHASE_CODE));
