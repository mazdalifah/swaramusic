...
public class SongByServerPlaylistActivity extends BaseActivity {
    ...
    private void loadSongs() {
        if (methods.isNetworkAvailable()) {
            LoadSong loadSong = new LoadSong(new SongListener() {
                ...
                public void onStart() {
                    if (isScroll) {
                        ...
                        adapter_song.notifyItemRemoved(arrayList.size());
                    }
                    if (arrayList.size() == 0) {
                        arrayList.clear();
            ...
            },methods.getAPIRequest(ItemName.METHOD_SONG_BY_PLAYLIST, page, "", "", "", "", "", "", "", itemServerPlayList.getId(),"","","","","","","", null));
            loadSong.execute();
    ...
    private void setAdapter() {
        adapter_song = new AdapterAllSongList(SongByServerPlaylistActivity.this, arrayList, new ClickListenerPlayList() {
            @Override
